...
ENV PHP_VERSION=71 XDEBUG_VERSION=2.5.5 IONCUBE_VERSION=7.1 PHPREDIS_VERSION=3.1.6
...
yum install -y crontabs which logrotate rsyslog rsyslog-elasticsearch \
